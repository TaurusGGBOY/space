...
class __ContentState extends State<_Content> {
                      ...
                      children: <Widget>[
                        Column(
                          ...
                          children: <Widget>[
                            ...
                            Text("你在${planetName[state.planet]}的体重是"),
                          ],
                        ),
                      ],
                    )),
  ...
  String _currentWeight(Calculator state) {
    if (_showKg) return (state.weight / 2.20462262).round().toString() + " 公斤";
    return state.weight.round().toString() + " 磅";
  }
